...
<span id="enrollform-header">Enrollment Application Form</span>
  ...
  <div id="enrollform-base">
    ...
    <hr>
        ...
        <label for="documents">Viewing Student Record From :</label>
        <div style="width: 100%;" class="file-upload" id="file-upload">
                   <div class="form-field">
          <br>
           <a class="btn btn-outline-secondary" href="{{url('admin/records',$user->id) }}" role="button">S.Y. {{$user->schoolyear_start}} - {{$user->schoolyear_end}}</a>
        </div>
    ...
    <div class="enrollment-form-field">
      ...
      <div class="form-field">
        ...
        <div class="form-field form-check @error('returningstudent') is-invalid |@enderror">
          ...
          <div>
            <input class="form-check-input" type="radio" name="studenttype" id="studenttype" value="Transferee" {{ old('studenttype') ? 'checked' : ''}} onclick="show1();" @if($user->studenttype == 'Transferee')checked @endif>
   ...
   <div id='extension_name' >
    ...
    <div id="transfer" class="transferee"  @if($user->studenttype == 'Old Student') style="display:none;" @endif>
      ...
      <a href="{{url('admin/old',$user->id) }}"id="submit-enrollment-application">Print Enrolment Form</a>
    </div>
    <div class="enrollment-form-field">
      @isset($current)
    <a class="btn btn-md btn-warning" href="{{route('admin.users.show',$current) }}" role="button">Go Back to Latest Enrolment Form</a>
    @endisset
    </div>
  </div>
</div>
