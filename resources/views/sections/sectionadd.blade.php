...
<input type="hidden" name="strand" value="{{$strandname->name}} ">
    ...
    <div class="form-field">
        ...
        <input placeholder="###" name="lower_gwa" type="number" class="@error('lowergrade_limit') is-invalid |@enderror" id="lowergwa_limit" aria-describedby="lowergwa_limit" value="{{old('lowergwa_limit')}}" maxlength="3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); "  onchange="
        ...
        <input placeholder="###" name="upper_gwa" type="number" class="@error('uppergrade_limit') is-invalid |@enderror" id="uppergwa_limit" aria-describedby="uppergwa_limit" value="{{old('uppergwa_limit')}}" maxlength="3" oninput="javascript: if (this.value.length > this.maxLength) this.value = this.value.slice(0, this.maxLength); "  onchange="
        if (this.value < 0 || this.value > 100) { 
          this.style.borderColor = 'red'; 
          document.getElementById('ga-alert').style.display = 'block' 
          }
...
<div class="enrollment-form-field" >
 ...
 <label for="schoolid">Starts at Monday:</label>
        <input placeholder="Section Number" name="starts_at_monday[{{$row }}]" type="time" class="@error('section_number') is-invalid |@enderror" id="guardianfirstname" aria-describedby="section_number" value="" >
        @error('section_number')
        <span class="invalid-feedback" role="alert">
          {{$message}}
        </span>
